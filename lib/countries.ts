...
// Full ISO 3166-1 alpha-2 country list (Spanish names) — every flag emoji getCountryFlag()
// can render is backed by an actual selectable country here, not just a curated subset.
...
// two-letter code as plain text instead), so getCountryFlag()'s emoji is unreliable as the
