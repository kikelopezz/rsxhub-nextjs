...
const home: typeof es = {
  hero: {
    slides: [
      ...
      'Well-run grids, official results, and a community that lives motorsport.',
      'From qualifying to the checkered flag: every session counts toward the championship.',
      'Teams, drivers, and cars competing under the same rules as the top real-world series.',
      'The thrill of endurance racing, broadcast live for the whole community.',
    ],
